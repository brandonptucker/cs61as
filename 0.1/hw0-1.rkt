...
#|
I think this has to do with lazy evaluation. It seems that the cases for `if` are lazy evaluated. For procedures, it seems that they are not lazy evaluated.
