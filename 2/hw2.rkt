...
(define (estimate-pi)
  (define (pi-term n) (/ (* 4.0 (square n)) (- (* 4.0 (square n)) 1)))
  (* 2.0 (product pi-term 1 add1 100))
)
...
(define (prod-of-some-numbers n)
  (filtered-accumulate * 1 (lambda (x) x) 1 add1 n (lambda (y) (rel-prime? y n)))
)
